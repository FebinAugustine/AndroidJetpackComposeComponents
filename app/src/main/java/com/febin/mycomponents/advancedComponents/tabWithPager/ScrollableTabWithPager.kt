...
@Composable
fun ScrollableTabWithPagerComp(
...
val tabData: List<TabItem> = tabItems
...
@Composable
fun ScrollableTabWithPagerCompPreview() {
    ScrollableTabWithPagerComp(modifier = Modifier.fillMaxSize())
}